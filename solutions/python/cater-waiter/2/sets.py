...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    ingrediente = set(dish_ingredients)
    return (dish_name,ingrediente)
...
def tag_special_ingredients(dish):
    ...
    ing_comun = set(dish[1]).intersection(SPECIAL_INGREDIENTS)
    return (dish[0], ing_comun)
...
def singleton_ingredients(dishes, intersection):
    ...
    """
    all_ = set().union(*dishes)
    return all_ - intersection        
